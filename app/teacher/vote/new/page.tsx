  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[60vh] gap-3">
        ...
        <span className="font-space text-xs tracking-widest" style={{ color: 'rgba(26,26,46,0.3)' }}>LOADING MISSIONS…</span>
      </div>
    );
  }
  ...
  return (
    <div className="px-8 py-8 max-w-4xl mx-auto">
      ...
      <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
        <h1 className="font-space font-black tracking-[0.1em] mb-2" style={{ fontSize: 24, color: '#1a1a2e' }}>
      ...
      <div className="mb-8">
        <p className="font-space text-[10px] tracking-[0.2em] mb-4" style={{ color: 'rgba(26,26,46,0.35)' }}>
          STEP 1 — REVIEW MISSIONS
        </p>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-4 px-5 py-4">
                  {/* Order */}
                  <span className="font-space font-black text-xl w-7 flex-shrink-0" style={{ color: 'rgba(26,26,46,0.15)' }}>
                    {String(mission.order).padStart(2, '0')}
                  </span>
                  <div className="flex-1 min-w-0">
                    <p className="font-inter text-[11px] mb-0.5" style={{ color: 'rgba(26,26,46,0.4)' }}>
                      {mission.projectTitle}
                    </p>
                    <p className="font-space font-bold text-sm leading-snug" style={{ color: '#1a1a2e' }}>
                      {mission.question}
                    </p>
                  </div>
                ...
                {mission.questionDescription && (
                  <div className="px-5 pb-4 -mt-1">
                    <p className="font-inter text-xs leading-relaxed" style={{ color: 'rgba(26,26,46,0.4)' }}>
                      {mission.questionDescription}
                    </p>
                  </div>
                )}
                      ...
                      >
                        ...
                        <button
                          ...
                          style={{
                            ...
                            color: '#8B00FF',
                            border: '1px dashed rgba(139,0,255,0.25)',
                          }}
                        >
      ...
      <div className={`max-w-sm mb-8${voteActive ? ' opacity-0 pointer-events-none select-none h-0 overflow-hidden mb-0' : ''}`}>
        ...
        <div className="glass-panel rounded-xl overflow-hidden flex flex-col gap-0">
          <div className="flex flex-col gap-1 px-4 py-3" style={{ borderBottom: '1px solid rgba(255,255,255,0.6)' }}>
            <label className="font-space text-[9px] font-bold tracking-[0.15em]" style={{ color: 'rgba(26,26,46,0.4)' }}>
              START DATE
            </label>
            <input
              type="datetime-local"
      ...
      {/* Preview banner */}
      <div
        className={`glass-panel rounded-xl px-5 py-4 mb-6${voteActive ? ' hidden' : ''}`}
        style={{ borderColor: 'rgba(139,0,255,0.15)' }}
      >
        <p className="font-inter text-xs leading-relaxed" style={{ color: 'rgba(26,26,46,0.55)' }}>
          🗳️ <span style={{ color: '#1a1a2e', fontWeight: 600 }}>Ready to open the vote.</span>{' '}
          ...
          {startDate && new Date(startDate) > new Date()
            ? <>{' '}Opens on <span style={{ color: '#1a1a2e', fontWeight: 600 }}>{new Date(startDate).toLocaleString()}</span>.</>
            : ' Opens immediately.'}
          {' '}Closes on <span style={{ color: '#1a1a2e', fontWeight: 600 }}>{endDate ? new Date(endDate).toLocaleString() : '—'}</span>.
      ...
      {voteActive ? (
        <motion.div
          ...
          style={{ padding: 24, borderColor: 'rgba(14,165,233,0.25)' }}
        >
          {/* Live badge */}
          <div className="flex items-center gap-2 mb-5">
            ...
            />
            <p className="font-space text-[10px] tracking-[0.2em]" style={{ color: '#0369A1' }}>
              VOTE IS LIVE
            </p>
            <button
          ...
          <div className="text-center mb-6">
            ...
            <p className="font-space font-black text-4xl tracking-wider" style={{ color: '#1a1a2e' }}>
          ...
          <div className="relative group">
            <motion.button
              ...
              style={{
                ...
                color: '#fff',
                border: `1px solid ${copied ? 'rgba(5,150,105,0.5)' : 'rgba(37,211,102,0.45)'}`,
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-4">
            <button
              ...
              style={{ background: 'rgba(26,26,46,0.04)', color: 'rgba(26,26,46,0.4)', border: '1px solid rgba(26,26,46,0.08)' }}
            >
              CANCEL
            </button>
            <motion.button
              ...
              style={{
                background: canStartVote
                  ...
                  : 'rgba(26,26,46,0.05)',
                color: canStartVote ? '#fff' : 'rgba(26,26,46,0.25)',
